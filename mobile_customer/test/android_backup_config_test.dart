...
/// Guards the data-retention fix: uninstalling the app must clear ALL user
/// data (email, auth token, saved session). If Android auto-backup were
/// re-enabled, SharedPreferences would survive reinstall and the customer's
/// email/session would be silently retained — the opposite of the intended
/// behavior. This test fails if `allowBackup` is ever flipped back to true.
void main() {
